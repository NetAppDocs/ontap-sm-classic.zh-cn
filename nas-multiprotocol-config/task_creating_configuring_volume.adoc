...
+
image::../media/namespace_1_before_nas_mp.gif[本图通过周围的文字进行了说明。]
...
.. 选择您喜欢的安全模式，然后单击 * 保存并关闭 * 。
+
image::../media/volume_edit_security_style_unix_to_ntfs_nas_mp.gif[本图通过周围的文字进行了说明。]
