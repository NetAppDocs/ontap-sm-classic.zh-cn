...
. *可选：*启用或禁用加密。
. * 可选： * 单击 image:../media/advanced_options.gif[""] 修改 FlexCache 卷高级设置。请参见 link:task_specifying_advanced_options_for_flexcache_volume.md#GUID-021C533F-BBA1-41A9-A191-DE223A158B4B["设置 FlexCache 卷的高级设置"]。
. 单击 * 保存 * 以保存更改。
